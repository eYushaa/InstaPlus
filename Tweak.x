...
// ============================================================================
// INSTAPLUS FEED LONG PRESS HANDLER
// ============================================================================
%hook IGFeedItemCell
- (void)layoutSubviews {
    %orig;
    if (!objc_getAssociatedObject(self, "InstaPlusFeedLongPress")) {
        UILongPressGestureRecognizer *lp = [[UILongPressGestureRecognizer alloc] initWithTarget:[DMMediaOverlayManager sharedManager] action:@selector(handleFeedLongPress:)];
        lp.minimumPressDuration = 0.5;
        [(UIView *)self addGestureRecognizer:lp];
        objc_setAssociatedObject(self, "InstaPlusFeedLongPress", @YES, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
}
%end
